...
def run_prediction(config_file):
    ...
    if average_mode == True:
        patches_imgs_test, new_height, new_width, masks_test = get_data_testing_overlap(
            test_imgs_original=DRIVE_test_imgs_original,  # original
    ...
    if average_mode == True:
        ...
        pred_imgs = recompone(pred_patches, 41, 59)  # predictions
        orig_imgs = recompone(patches_imgs_test, 41, 59)  # originals
