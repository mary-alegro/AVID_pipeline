...
from convnet.util.help_functions import visualize
from convnet.util.help_functions import group_images
...
#Load the original data and return the extracted patches for training/testing
def get_data_testing(test_imgs_original, test_groudTruth, Imgs_to_test, mean_image_path, patch_height, patch_width, is_color=True):
    ### test
...
def get_data_segmenting_overlap(test_img_original, Imgs_to_test, mean_image_path, patch_height, patch_width, stride_height, stride_width, is_color=True):
    ...
    #test_mask = test_mask[0:Imgs_to_test,:,:,:]
...
# Load the original data and return the extracted patches for testing
# return the ground truth in its original shape
def get_data_testing_overlap(test_imgs_original, test_groudTruth, Imgs_to_test, mean_image_path, patch_height, patch_width, stride_height, stride_width, is_color=True):
    ### test
    test_imgs_original = load_hdf5(test_imgs_original)
    test_masks = load_hdf5(test_groudTruth)
