...
def main():
    ...
    plt.plot(AV13_AT100_test_stats[:, 5], AV13_AT100_test_stats[:, 3],'--', color='green',lw=lw, label='#1 Test (AUC {:.4f})'.format(AV13_AT100_auc_test))
    plt.plot(AV13_AT100_val_stats[:, 5], AV13_AT100_val_stats[:, 3],'--', color='yellow', lw=lw, label='#1 Validation (AUC {:.4f})'.format(AV13_AT100_auc_val))
    plt.plot(AV23_AT100_test_stats[:, 5], AV23_AT100_test_stats[:, 3],'--', color='peru',lw=lw, label='#2 Test (AUC {:.4f})'.format(AV23_AT100_auc_test))
    plt.plot(AV23_AT100_val_stats[:, 5], AV23_AT100_val_stats[:, 3],'--', color='gray', lw=lw, label='#2 Validation (AUC {:.4f})'.format(AV23_AT100_auc_val))
    ...
    plt.plot(AV13_AT8_test_stats[:, 5], AV13_AT8_test_stats[:, 3],'--', color='blue',lw=lw, label='#1 Test (AUC {:.4f})'.format(AV13_AT8_auc_test))
    plt.plot(AV13_AT8_val_stats[:, 5], AV13_AT8_val_stats[:, 3],'--', color='red', lw=lw, label='#1 Validation (AUC {:.4f})'.format(AV13_AT8_auc_val))
    plt.plot(AV23_AT8_test_stats[:, 5], AV23_AT8_test_stats[:, 3],'--', color='hotpink',lw=lw, label='#2 Test (AUC {:.4f})'.format(AV23_AT8_auc_test))
    plt.plot(AV23_AT8_val_stats[:, 5], AV23_AT8_val_stats[:, 3],'--', color='lime', lw=lw, label='#2 Validation (AUC {:.4f})'.format(AV23_AT8_auc_val))
